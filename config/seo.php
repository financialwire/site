...
return [
    ...
    'description' => [
         ...
         */
        'fallback' => 'Controle suas economias de maneira simples e eficiente, com ferramentas intuitivas que simplificam o planejamento financeiro.',
    ],
    ...
    'image' => [
         ...
         */
        'fallback' => asset('images/seo/banner.webp'),
    ],
